...
int main() {
	...
	cout << "Data Ha4ala CTpouTelcTBA: " << start << endl;
	cout << "Bpemya CTpouTelcTBA: " << constructing << endl;
	cout << "DaTa Cda4u objekta(Data+Data): " << end << endl;
	end = start - constructing;
	cout << "Data Ha4ala CTpouTelcTBA objekta(Data-Data): " << end << endl;
	end = start + 29;
	cout << "Data Cda4u objekta(Data+Int): " << end << endl;
	end = end - 29;
	cout << "Data Ha4ala CTpouTelcTBA objekta(Data-Int): " << end << endl;
	end = start++;
	cout << "Data Cda4u objekta(Data++): " << end << endl;
	end = end--;
	cout << "Data Ha4ala CTpouTelcTBA objekta(Data--): " << end << endl;
	return 0;
}
